    ...
    <div>
      ...
      <div className="bg-gray-300 p-6 text-center">
        <a
          ...
          href="/membership/academic/members"
          role="button"
        >
          View Members
        </a>
      ...
      >
        ...
        <div className="container relative mx-auto">
          ...
          data-aos-duration="1000" className="mt-4 text-lg text-gray-300">
                  ICT Academy of Kerala (ICTAK) is pleased to offer its Premium
                  Memberships to selected Engineering , Science & Management
                  Institutions and Polytechnics in the state. Through the
                  programme, ICTAK will support its members institution’s
                  Faculty members, Students and Staffs with quality training
                  resources, certifications and Industry immersions on IR4.0
                  Technologies, and thereby enabling them to reach their
      ...
      <section className="pb-20 bg-gray-300 -mt-24">
        <div className="container mx-auto px-4">
          ...
          data-aos-duration="1000" className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
              <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                <div className="px-4 py-5 flex-auto">
                  <div className="text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-red-400">
                    <i className="fas fa-award"></i>
                  </div>
                  <h6 className="text-xl font-semibold">For Faculty</h6>
                  <ul
                    style={{ listStyle: "outside" }}
                    className="mt-2 mb-4 text-gray-600 p-4"
                  >
                    <li className="text-justify">
                      Faculty Benefits Access to Partner Curriculum.
                    </li>
                    <li className="text-justify">
                      Faculty development program from Salesforce, Oracle
                      Academy, Google, and Microsoft.
                    </li>
                    <li className="text-justify">
                      Industrial visit. Opportunity to see, interact, and
                      experience the industry innovations.
                    </li>
                    <li className="text-justify">
                      Opportunity to publish their works in our international
                      magazine.
                    </li>
                  </ul>
                </div>
          ...
          data-aos-duration="1000" className="w-full md:w-4/12 px-4 text-center">
              <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                <div className="px-4 py-5 flex-auto">
          ...
          data-aos-duration="1000" className="pt-6 w-full md:w-4/12 px-4 text-center">
              <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                <div className="px-4 py-5 flex-auto">
                  <div className="text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-green-400">
                    <i className="fas fa-fingerprint"></i>
                  </div>
                  <h6 className="text-xl font-semibold">For Students</h6>
                  <ul
                    style={{ listStyle: "outside" }}
                    className="mt-2 mb-4 text-gray-600 p-4"
                  >
                    <li className="text-justify">
                      Free training on industrial skills with global leaders
                      like Microsoft, Oracle Academy, Google, Salesforce, AWS,
                      and AAU in IR 4.0 technology domain.
                    </li>
                    <li className="text-justify">
                      Students from partner institutions benefit from the
                      learning enrichment programs like ICSET, Techathlon, and
                      Student Top 10.
                    </li>
                  </ul>
                </div>
            ...
            <div className="w-full md:w-4/12 px-4 text-center">
              {/* <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                <div className="px-4 py-5 flex-auto">
                  ...
                  <h6 className="text-xl font-semibold">For Institutions</h6>
                  <ul style={{listStyle:'outside'}} className="mt-2 mb-4 text-gray-600 p-4">
                    <li className="text-justify">Access to ICTAK corporate partner pre-programs and events.</li>
                    <li className="text-justify">Employability Quotient Test (EQT) to all the students to know their industrial skills.</li>
                    <li className="text-justify">Support for educators on partner program curriculum delivery and integration.</li>
                    <li className="text-justify">Connection and support to virtual and on-campus events.</li>
                    <li className="text-justify">Joint PR opportunities with ICT Academy of Kerala.</li>
                  </ul>
                </div>
              </div> */}
            </div>
              ...
              <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                <div className="px-4 py-5 flex-auto">
                  ...
                  >
                    ...
                    <li className="text-justify">
                      Employability Quotient Test (EQT) to all the students to
                      know their industrial skills.
                    </li>
                    <li className="text-justify">
                      Support for educators on partner program curriculum
          ...
          <div className="flex flex-wrap items-center mt-32">
            <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
              ...
              <h2 data-aos="fade-up"
          data-aos-duration="1000" className="text-4xl font-bold">Commercial and Validity Period</h2>
              <br />
              <p data-aos="fade-up"
          data-aos-duration="1000" className="text-xl">
      ...
      <section className=" relative py-20 bg-blue-300">
        ...
        <div data-aos="fade-down"
          data-aos-duration="1000" style={{marginLeft:"100px",marginRight:'100px',borderRadius:"20px",boxShadow:"rgba(0, 0, 0, 0.151) 10px 10px 10px"}} className="m-2 p-2 bg-white">
        <div className="p-8">
        <p style={{color:"#036BCB"}} className="text-center text-3xl font-bold">
